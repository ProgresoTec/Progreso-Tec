...
<!--                        <div class="nav-item dropdown">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                <a href="price.php" class="dropdown-item">Plan de Precios</a>
                                <a href="feature.php" class="dropdown-item">Nuestras Características</a>
                                <a href="team.php" class="dropdown-item">Miembros del Equipo</a>
                                <a href="testimonial.php" class="dropdown-item">Testimonios</a>
                                <a href="quote.php" class="dropdown-item">Cotización Gratis</a>
                            </div>
                        </div>-->
                        <a href="contact.php" class="nav-item nav-link">Contacto</a>
                    </div>
                    <a href="#" class="btn btn-primary py-2 px-4 ms-3">Acceso</a>
                </div>
            ...
            <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
                <div class="row py-5">
                    <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                        ...
                        <a href="" class="h5 text-white">Precios</a>
                    </div>
                </div>
            </div>
        </div>
