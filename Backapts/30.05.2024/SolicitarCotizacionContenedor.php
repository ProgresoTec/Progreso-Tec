        ...
        <div class="row g-5">
            <div class="col-lg-7">
                <div class="section-title position-relative pb-3 mb-5">
                    ...
                    <h1 class="mb-0">¿Necesita una Cotización Gratuita? No Dude en Contactarnos</h1>
                </div>
                <div class="row gx-3">
                ...
                <div class="d-flex align-items-center mt-2 wow zoomIn" data-wow-delay="0.6s">
                    ...
                    <div class="ps-4">
                        ...
                        <h4 class="text-primary mb-0">+51 908 756 902</h4>
                    </div>
                </div>
            </div>
            <div class="col-lg-5">
                <div class="bg-primary rounded h-100 d-flex align-items-center p-5 wow zoomIn" data-wow-delay="0.9s">
                    <form>
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control bg-light border-0" placeholder="Su Numero Telefonico" style="height: 55px;">
                            </div>
                            ...
                            <div class="col-12">
                                <button class="btn btn-dark w-100 py-3" type="submit">Solicitar una Cotización</button>
                            </div>
                        </div>
                    </form>
                </div>
